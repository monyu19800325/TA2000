...
namespace TA2000Modules
{
    ...
    {
        //public List<VelocityData> CX1VelList; //視覺橫移軸
        //public List<VelocityData> CZ1VelList; //視覺升降軸
        //public List<VelocityData> AY1VelList; //吸嘴縱移軸
        //public List<VelocityData> AZ1VelList; //吸嘴升降軸

        public List<VelocityData> AY1VelList; //視覺縱移軸
        public List<VelocityData> BZ1VelList; //BZ1_流道頂升升降軸
        public List<VelocityData> BX1VelList; //BX1_流道橫移軸
        public Velocity _InspectVelocity;

        [DefineHardware] public ISensor BarcodeReader;
        [DefineHardware] public ISensor LaserReader;
        private ILaserDistanceFinder _laserFinder;
