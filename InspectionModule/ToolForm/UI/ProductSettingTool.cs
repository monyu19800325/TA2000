...
namespace TA2000Modules
{
    ...
    {
        ProductSettingToolViewModel _viewModel;
        ...
        void InitializeBindings(InspectionModule module)
        {
            ...
            fluent.BindCommand(Btn_AddLaser, x => x.AddLaser());
            //fluent.BindCommand(Btn_DeleteLaser, x => x.DeleteLaser());
            fluent.BindCommand(Btn_CalcHeight, x => x.CalcLaser);
            fluent.BindCommand(Btn_SaveLaser, x => x.SaveLaser());
            fluent.BindCommand(Btn_ReadMap, x => x.ReadMap());
            ...
            fluent.SetBinding(NUD_YPos, x => x.Value, x => x.YPos);
            ...
            fluent.SetBinding(NUD_MaxZ, x => x.Value, x => x.MaxZ);
            fluent.SetBinding(NUD_MinZ, x => x.Value, x => x.MinZ);
            fluent.SetBinding(NUD_BestZ, x => x.Value, x => x.BestZ);


            gridControl1.DataSource = fluent.ViewModel.LaserSetting.LaserPoints;
            ...
            btnDelete.ButtonClick += fluent.ViewModel.DeleteLaser;
            ...
            gridView1.Columns["ZValue"].OptionsColumn.AllowEdit = false;
            gridView1.Columns["ZValue"].AppearanceCell.BackColor = Color.GhostWhite;
            gridView1.Columns["ZValue"].AppearanceCell.Options.UseBackColor = true;
        }
        ...
        private void ProductSettingTool_Shown(object sender, EventArgs e)
        {
            //_viewModel.ReadMap();
        }
    }
